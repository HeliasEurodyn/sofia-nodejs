...
module.exports = {
      ...
      getservice_app_viewById: async ({ id, userId }) => {
      ...
      try {
         ...
         const service_app_viewFilters = [id
         ];
         const [service_app_view_results] = await conn.execute(
         `SELECT sharing_type_id, profiles, building_profile, id, sharing_type, profile, user_profile, title, process_tags, type, business_tags, user_profile_code, building_profile_code, energy_profile, data_sharing_method, vocabulary_keywords, data_sharing_method_code, energy_profile_code, type_code
