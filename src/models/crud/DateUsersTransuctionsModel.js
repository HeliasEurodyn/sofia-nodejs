...
module.exports = {
   ...
   getById: async (id) => {
      ...
      try {
         ...
         const date_users_transuctionsFilters = {
            date_users_transuctions_obj_files_total: id
         };
         const [date_users_transuctions_results] = await conn.query(
         ...
         WHERE date_users_transuctions.files_total = :date_users_transuctions_obj_files_total;`, date_users_transuctionsFilters );
