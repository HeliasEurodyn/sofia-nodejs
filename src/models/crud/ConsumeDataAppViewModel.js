...
module.exports = {
   ...
   getById: async ({ id, userId }) => {
      ...
      try {
         ...
         const consume_data_app_viewFilters = [id
         ];
         const [consume_data_app_view_results] = await conn.execute(
         ...
         WHERE consume_data_app_view.provide_data_id = ? `, consume_data_app_viewFilters );
         ...
         const service_wizard_field_valuesFilters = [consume_data_app_view?.provide_data_id
         ];
         const [service_wizard_field_values_results] = await conn.execute(
         `SELECT provide_data_id, id, offering_id, field_id, field_value
          FROM service_wizard_field_values
         WHERE service_wizard_field_values.provide_data_id = ? `, service_wizard_field_valuesFilters );
