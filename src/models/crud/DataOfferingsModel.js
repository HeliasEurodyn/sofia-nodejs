...
module.exports = {
   ...
   getById: async ({ id, userId }) => {
      ...
      try {
         ...
         const data_catalog_data_offeringsFilters = [id
         ];
         ...
         const user_1_1Filters = [data_catalog_data_offerings?.created_by
         ];
         const [user_1_1_results] = await conn.execute(
         `SELECT username, id, email
          FROM  ( SELECT id, username, email  FROM user ) user_1_1
         WHERE user.id = ? `, user_1_1Filters );
         ...
         const companyFilters = [user?.company_id
         ];
         ...
         const data_catalog_data_offerings_countriesFilters = [data_catalog_data_offerings?.id
         ];
         const [data_catalog_data_offerings_countries_results] = await conn.execute(
         `SELECT id, data_catalog_data_offering_id, country_id
          FROM data_catalog_data_offerings_countries
         WHERE data_catalog_data_offerings_countries.data_catalog_data_offering_id = ? `, data_catalog_data_offerings_countriesFilters );
         ...
         for (const data_catalog_data_offerings_countries of data_catalog_data_offerings_countries_results)
            ...
            const countryFilters = [data_catalog_data_offerings_countries?.country_id
            ];
         ...
         const data_catalog_data_offerings_clustersFilters = [data_catalog_data_offerings?.id
         ];
         const [data_catalog_data_offerings_clusters_results] = await conn.execute(
         `SELECT id, data_catalog_data_offering_id, cluster_id
          FROM data_catalog_data_offerings_clusters
         WHERE data_catalog_data_offerings_clusters.data_catalog_data_offering_id = ? `, data_catalog_data_offerings_clustersFilters );
         ...
         for (const data_catalog_data_offerings_clusters of data_catalog_data_offerings_clusters_results)
            ...
            const clusterFilters = [data_catalog_data_offerings_clusters?.cluster_id
            ];
         ...
         const data_catalog_data_offerings_marketsFilters = [data_catalog_data_offerings?.id
         ];
         const [data_catalog_data_offerings_markets_results] = await conn.execute(
         `SELECT id, data_catalog_data_offering_id, market_id
          FROM data_catalog_data_offerings_markets
         WHERE data_catalog_data_offerings_markets.data_catalog_data_offering_id = ? `, data_catalog_data_offerings_marketsFilters );
         ...
         for (const data_catalog_data_offerings_markets of data_catalog_data_offerings_markets_results)
            ...
            const marketFilters = [data_catalog_data_offerings_markets?.market_id
            ];
         ...
         const data_catalog_data_offerings_onenet_rolesFilters = [data_catalog_data_offerings?.id
         ];
         const [data_catalog_data_offerings_onenet_roles_results] = await conn.execute(
         `SELECT id, onenet_role_id, data_catalog_data_offering_id
          FROM data_catalog_data_offerings_onenet_roles
         WHERE data_catalog_data_offerings_onenet_roles.data_catalog_data_offering_id = ? `, data_catalog_data_offerings_onenet_rolesFilters );
         ...
         for (const data_catalog_data_offerings_onenet_roles of data_catalog_data_offerings_onenet_roles_results)
            ...
            const onenet_roleFilters = [data_catalog_data_offerings_onenet_roles?.onenet_role_id
            ];
