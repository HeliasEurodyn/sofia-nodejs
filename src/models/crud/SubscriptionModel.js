   ...
   getById: async (id) => {
      ...
      try {
         ...
         const subscriptionFilters = {
            subscription_obj_id: id
         };
         const [subscription_results] = await conn.query(
         `SELECT id, created_by, created_on, modified_by, modified_on, subscription_user, status, offering_id, comments
          FROM subscription
         WHERE subscription.id = :subscription_obj_id;`, subscriptionFilters );
         ...
         const offering_app_viewFilters = {
            offering_app_view_obj_id: subscription?.offering_id
         };
         const [offering_app_view_results] = await conn.query(
         ...
         WHERE offering_app_view.id = :offering_app_view_obj_id;`, offering_app_viewFilters );
         ...
         const subscription_app_viewFilters = {
            subscription_app_view_obj_id: subscription?.id
         };
         const [subscription_app_view_results] = await conn.query(
         ...
         WHERE subscription_app_view.id = :subscription_app_view_obj_id;`, subscription_app_viewFilters );
