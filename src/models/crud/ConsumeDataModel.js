...
module.exports = {
   ...
   getById: async ({ id, userId }) => {
      ...
      try {
         ...
         const subscription_offering_app_viewFilters = [provide_data?.service_offering_id,userId
         ];
         const [subscription_offering_app_view_results] = await conn.execute(
         ...
         WHERE subscription_offering_app_view.offering_id = ? subscription_offering_app_view.subscription_user_id = ? `, subscription_offering_app_viewFilters );
