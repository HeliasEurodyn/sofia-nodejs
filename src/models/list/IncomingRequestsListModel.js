...
module.exports = {
   ...
   listFields: {
      ...
      cf_comments: { virtual: false, db_table: 'subscription', db_field: 'comments', section: 'column', type: 'text', primary: false, autoIncrement: false, filterOperator: 'like' },
      cf_service_title: { virtual: false, db_table: 'offering_app_view', db_field: 'service_title', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'like' },
      cf_data_sharing_method: { virtual: false, db_table: 'offering_app_view', db_field: 'data_sharing_method', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'like' },
      cf_type: { virtual: false, db_table: 'offering_app_view', db_field: 'type', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'like' },
      cf_business_tags: { virtual: false, db_table: 'offering_app_view', db_field: 'business_tags', section: 'column', type: 'mediumtext', primary: false, autoIncrement: false, filterOperator: '=' },
      cf_process_tags: { virtual: false, db_table: 'offering_app_view', db_field: 'process_tags', section: 'column', type: 'mediumtext', primary: false, autoIncrement: false, filterOperator: '=' },
      cf_profiles: { virtual: false, db_table: 'offering_app_view', db_field: 'profiles', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'like' },
      cf_vocabulary_keywords: { virtual: false, db_table: 'offering_app_view', db_field: 'vocabulary_keywords', section: 'column', type: 'mediumtext', primary: false, autoIncrement: false, filterOperator: '=' },
      cf_created_on: { virtual: false, db_table: 'subscription', db_field: 'created_on', section: 'column', type: 'datetime', primary: false, autoIncrement: false, filterOperator: '=' },
      cf_sharing_type: { virtual: false, db_table: 'offering_app_view', db_field: 'sharing_type', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'like' },
      ...
      ft_offering_user_id: { virtual: false, db_table: 'offering_app_view', db_field: 'offering_user_id', section: 'filter', type: 'varchar', primary: false, autoIncrement: false, filterOperator: '=' }
   },
   ...
   getList: async ({ filters, userId }) => {
      ...
      try {
         ...
         SELECT 
            ...
            (SELECT CONCAT( IF(company.id IS NOT NULL, CONCAT(company.name, ' <i class="fa fa-caret-right"></i> '), ''), user.username ) FROM user user LEFT JOIN company company ON user.company_id = company.id WHERE user.id = subscription.subscription_user) as sqlf_11
