...
module.exports = {
   ...
   listFields: {
      id: { virtual: false, db_table: 'data_catalog_data_offerings', db_field: 'id', section: 'column', type: 'varchar', primary: true, autoIncrement: false, filterOperator: '=' },
      file_schema: { virtual: false, db_table: 'data_catalog_data_offerings', db_field: 'file_schema', section: 'column', type: 'longtext', primary: false, autoIncrement: false, filterOperator: '=' },
      file_schema_filename: { virtual: false, db_table: 'data_catalog_data_offerings', db_field: 'file_schema_filename', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'like' },
      file_schema_sample: { virtual: false, db_table: 'data_catalog_data_offerings', db_field: 'file_schema_sample', section: 'column', type: 'longtext', primary: false, autoIncrement: false, filterOperator: '=' },
      file_schema_sample_filename: { virtual: false, db_table: 'data_catalog_data_offerings', db_field: 'file_schema_sample_filename', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'like' },
      ...
      profile_format: { virtual: false, db_table: 'data_catalog_data_offerings', db_field: 'input_profile', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'like' },
      ...
      data_catalog_business_object_name: { virtual: false, db_table: 'data_catalog_business_object', db_field: 'name', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'like' },
