...
module.exports = {
   ...
   listFields: {
      ...
      ft_created_by: { virtual: false,  db_table: 'data_catalog_business_object_comments',  db_field: 'created_by',  section: 'filter',  type: 'varchar',  primary: false,  autoIncrement: false }
   },
