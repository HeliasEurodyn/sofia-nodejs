...
module.exports = {
   ...
   listFields: {
      sqlf_7: { virtual: true, db_table: '', db_field: '', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: '=' },
      cf_title: { virtual: false, db_table: 'data_catalog_business_object_comments', db_field: 'title', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'like' },
      sqlf_5: { virtual: true, db_table: '', db_field: '', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: '=' },
      cf_status: { virtual: false, db_table: 'data_catalog_business_object_comments', db_field: 'status', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'like' },
      ...
      cf_id: { virtual: false, db_table: 'data_catalog_business_object_comments', db_field: 'id', section: 'column', type: 'varchar', primary: true, autoIncrement: false, filterOperator: 'like' },
      of_created_on: { virtual: false, db_table: 'data_catalog_business_object_comments', db_field: 'created_on', section: 'orderby', type: 'datetime', primary: false, autoIncrement: false, filterOperator: '=' },
      ft_created_by: { virtual: false, db_table: 'data_catalog_business_object_comments', db_field: 'created_by', section: 'filter', type: 'varchar', primary: false, autoIncrement: false, filterOperator: '=' }
   },
