...
module.exports = {
   ...
   listFields: {
      request_id: { virtual: false, db_table: 'data_catalog_data_requests', db_field: 'id', section: 'column', type: 'varchar', primary: true, autoIncrement: false, filterOperator: 'like' },
      ...
      user_requesting: { virtual: true, db_table: '', db_field: '', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: '=' },
      ...
      cf_viewed_by_offering_owner: { virtual: false, db_table: 'data_catalog_data_requests', db_field: 'viewed_by_offering_owner', section: 'column', type: 'int', primary: false, autoIncrement: false, filterOperator: '=' },
      cf_comments: { virtual: false, db_table: 'data_catalog_data_requests', db_field: 'comments', section: 'column', type: 'text', primary: false, autoIncrement: false, filterOperator: 'like' },
      ...
      ft_id_offering: { virtual: false, db_table: 'data_catalog_data_offerings', db_field: 'id', section: 'filter', type: 'varchar', primary: true, autoIncrement: false, filterOperator: '=' },
      ...
      ft_created_by: { virtual: false, db_table: 'data_catalog_data_offerings', db_field: 'created_by', section: 'filter', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'like' },
