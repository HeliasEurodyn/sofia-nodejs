...
module.exports = {
   ...
   listFields: {
      ...
      cf_onenet_user_id: { virtual: false, db_table: 'ids_resources', db_field: 'onenet_user_id', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'like' },
      cf_onenet_user_username: { virtual: false, db_table: 'ids_resources', db_field: 'onenet_user_username', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'like' },
      cf_onenet_user_email: { virtual: false, db_table: 'ids_resources', db_field: 'onenet_user_email', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'like' },
      ...
      ft_onenet_type: { virtual: false, db_table: 'ids_resources', db_field: 'onenet_type', section: 'filter', type: 'varchar', primary: false, autoIncrement: false, filterOperator: '=' }
   },
