...
module.exports = {
   ...
   listFields: {
      cf_provide_data_id: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'provide_data_id',  section: 'column',  type: 'varchar',  primary: true,  autoIncrement: false },
      provider: { virtual: true,  db_table: '',  db_field: '',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      header_icon_class: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'type_code',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      header_icon_old: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'type_code',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      header_image_path: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'type_code',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      header_label: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'title',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      offering_title: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'service_offering_title',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      cf_data_sharing_method_html: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'data_sharing_method_html',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      cf_type_html: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'type_html',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      description: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'business_tags_html',  section: 'column',  type: 'mediumtext',  primary: false,  autoIncrement: false },
      cf_process_tags_html: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'process_tags_html',  section: 'column',  type: 'mediumtext',  primary: false,  autoIncrement: false },
      cf_profiles_html: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'profiles_html',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      cf_vocabulary_keywords_html: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'vocabulary_keywords_html',  section: 'column',  type: 'mediumtext',  primary: false,  autoIncrement: false },
      footer_label: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'created_on',  section: 'column',  type: 'timestamp',  primary: false,  autoIncrement: false },
      cf_sharing_type: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'sharing_type',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      cf_offering_id: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'offering_id',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      cf_file_name: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'file_name',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      header_icon: { virtual: true,  db_table: '',  db_field: '',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      of_created_on: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'created_on',  section: 'orderby',  type: 'timestamp',  primary: false,  autoIncrement: false },
      ft_subscription_user_id: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'subscription_user_id',  section: 'filter',  type: 'varchar',  primary: false,  autoIncrement: false },
      ft_created_on: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'created_on',  section: 'filter',  type: 'timestamp',  primary: false,  autoIncrement: false },
      ft_created_on_1: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'created_on',  section: 'filter',  type: 'timestamp',  primary: false,  autoIncrement: false },
      ft_title: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'title',  section: 'filter',  type: 'varchar',  primary: false,  autoIncrement: false },
      ft_service_offering_title: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'service_offering_title',  section: 'filter',  type: 'varchar',  primary: false,  autoIncrement: false },
      ft_file_name: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'file_name',  section: 'filter',  type: 'varchar',  primary: false,  autoIncrement: false },
      lg_provider: { virtual: true,  db_table: '',  db_field: '',  section: 'leftgroup',  type: 'varchar',  primary: false,  autoIncrement: false },
      gf_service_offering_title: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'service_offering_title',  section: 'leftgroup',  type: 'varchar',  primary: false,  autoIncrement: false },
      gf_type_html: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'type_html',  section: 'leftgroup',  type: 'varchar',  primary: false,  autoIncrement: false },
      gf_service_offering_title_1: { virtual: false,  db_table: 'consume_data_app_view',  db_field: 'service_offering_title',  section: 'leftgroup_part',  type: 'varchar',  primary: false,  autoIncrement: false }
   },
   ...
   getLgProviderList: async (filters) => {
      const conn = await pool.getConnection();
   ...
   getGfServiceOfferingTitleList: async (filters) => {
      const conn = await pool.getConnection();
   ...
   getGfTypeHtmlList: async (filters) => {
      const conn = await pool.getConnection();
