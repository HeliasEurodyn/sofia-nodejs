...
module.exports = {
   ...
   listFields: {
      cf_owner: { virtual: true,  db_table: '',  db_field: '',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      ...
      cf_sharing_type: { virtual: false,  db_table: 'service_app_view',  db_field: 'sharing_type',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      ...
      owner_left_filter: { virtual: true,  db_table: '',  db_field: '',  section: 'leftgroup',  type: 'varchar',  primary: false,  autoIncrement: false },
      gf_data_sharing_method: { virtual: false,  db_table: 'service_app_view',  db_field: 'data_sharing_method',  section: 'leftgroup',  type: 'varchar',  primary: false,  autoIncrement: false }
   },
   ...
   getOwnerLeftFilterList: async (filters) => {
      const conn = await pool.getConnection();
   ...
   getGfDataSharingMethodList: async (filters) => {
      const conn = await pool.getConnection();
