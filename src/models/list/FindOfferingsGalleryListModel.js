...
module.exports = {
   ...
   listFields: {
      ...
      description_old: { virtual: true, db_table: '', db_field: '', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: '=' },
      footer_label: { virtual: true, db_table: '', db_field: '', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: '=' },
      cf_type: { virtual: false, db_table: 'service_app_view', db_field: 'type_code', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'like' },
      username: { virtual: true, db_table: '', db_field: '', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: '=' },
      usercountry: { virtual: true, db_table: '', db_field: '', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: '=' },
      usercountrycode: { virtual: true, db_table: '', db_field: '', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: '=' },
      ...
      service_id: { virtual: false, db_table: 'service_offering', db_field: 'service_id', section: 'filter', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'in' },
      ft_type: { virtual: false, db_table: 'service_app_view', db_field: 'type_code', section: 'filter', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'in' },
      ft_data_sharing_method_code: { virtual: false, db_table: 'service_app_view', db_field: 'data_sharing_method_code', section: 'filter', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'in' },
      ft_user_profile: { virtual: false, db_table: 'service_app_view', db_field: 'user_profile_code', section: 'filter', type: 'int', primary: false, autoIncrement: false, filterOperator: 'in' },
      ft_energy_profile: { virtual: false, db_table: 'service_app_view', db_field: 'energy_profile_code', section: 'filter', type: 'int', primary: false, autoIncrement: false, filterOperator: 'in' },
      ft_building_profile: { virtual: false, db_table: 'service_app_view', db_field: 'building_profile_code', section: 'filter', type: 'int', primary: false, autoIncrement: false, filterOperator: 'in' },
      ...
      ft_country_id: { virtual: true, db_table: '', db_field: '', section: 'filter', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'in' },
      ...
      ft_id: { virtual: false, db_table: 'service_offering', db_field: 'id', section: 'filter', type: 'varchar', primary: true, autoIncrement: false, filterOperator: 'in' },
      ...
      gf_title_1: { virtual: false, db_table: 'service_offering', db_field: 'title', section: 'leftgroup_part', type: 'varchar', primary: false, autoIncrement: false, filterOperator: '=' }
   },
