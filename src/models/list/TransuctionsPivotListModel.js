...
module.exports = {
   ...
   listFields: {
      cf_files_total: { virtual: false,  db_table: 'date_users_transuctions',  db_field: 'files_total',  section: 'column',  type: 'bigint',  primary: false,  autoIncrement: false },
      of_created_on: { virtual: false,  db_table: 'date_users_transuctions',  db_field: 'created_on',  section: 'orderby',  type: 'date',  primary: false,  autoIncrement: false },
      gf_provider: { virtual: false,  db_table: 'date_users_transuctions',  db_field: 'provider',  section: 'leftgroup',  type: 'text',  primary: false,  autoIncrement: false },
      gf_offering_title: { virtual: false,  db_table: 'date_users_transuctions',  db_field: 'offering_title',  section: 'leftgroup',  type: 'varchar',  primary: false,  autoIncrement: false },
      tgf_consumer: { virtual: false,  db_table: 'date_users_transuctions',  db_field: 'consumer',  section: 'topgroup',  type: 'text',  primary: false,  autoIncrement: false },
   ...
   getGfProviderList: async (filters) => {
      const conn = await pool.getConnection();
   ...
   getGfOfferingTitleList: async (filters) => {
      const conn = await pool.getConnection();
