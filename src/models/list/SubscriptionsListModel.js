...
module.exports = {
   ...
   listFields: {
      ...
      cf_offering_user: { virtual: false, db_table: 'offering_app_view', db_field: 'offering_user', section: 'column', type: 'varchar', primary: false, autoIncrement: false, filterOperator: 'like' },
