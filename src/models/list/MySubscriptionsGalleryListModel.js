...
module.exports = {
   ...
   listFields: {
      ...
      header_label: { virtual: false,  db_table: 'offering_app_view',  db_field: 'offering_title',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      header_icon_class: { virtual: false,  db_table: 'offering_app_view',  db_field: 'type_code',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      header_icon: { virtual: false,  db_table: 'offering_app_view',  db_field: 'type_code',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      header_image_path: { virtual: false,  db_table: 'offering_app_view',  db_field: 'type_code',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      description: { virtual: true,  db_table: '',  db_field: '',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      footer_label_: { virtual: true,  db_table: '',  db_field: '',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      cf_type: { virtual: false,  db_table: 'offering_app_view',  db_field: 'type_code',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      footer_label: { virtual: false,  db_table: 'offering_app_view',  db_field: 'offering_user',  section: 'column',  type: 'varchar',  primary: false,  autoIncrement: false },
      ...
      user_profile: { virtual: false,  db_table: 'offering_app_view',  db_field: 'user_profile',  section: 'column',  type: 'int',  primary: false,  autoIncrement: false },
      energy_profile: { virtual: false,  db_table: 'offering_app_view',  db_field: 'energy_profile',  section: 'column',  type: 'int',  primary: false,  autoIncrement: false },
      building_profile: { virtual: false,  db_table: 'offering_app_view',  db_field: 'building_profile',  section: 'column',  type: 'int',  primary: false,  autoIncrement: false },
